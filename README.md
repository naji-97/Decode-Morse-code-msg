...
**Morse Decoder** is a Ruby project built to automate the process od decrypting morse messages.
...
```sh
  git clone https://github.com/naji-97/Decode-Morse-code-msg.git
  cd Decode-Morse-code-msg
```
...
- [ ] **Decode Morse Messages in real-time**
